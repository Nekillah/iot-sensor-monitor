...
* The original package name 'com.demo.sensor-api' is invalid and this project uses 'com.demo.sensor_api' instead.
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/3.4.12/reference/messaging/amqp.html)
